...
const handleDelete = (marca) => {
    confirm.require({
        ...
        accept: () => {
            router.delete(
                route(
                    "admin.negocio.parametros.vehiculomarca.destroy",
                    marca.id
                ),
                {
                    onSuccess: () =>
                        toast.add({
                            severity: "success",
                            summary: "Éxito",
                            detail: "Marca de Vehículo eliminada.",
                            life: 3000,
                        }),
                }
            );
...
const handleSuccess = (message) => {
    ...
    router.reload({ only: ["vehiculoMarcas"] });
};
</script>
        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                >
                    ...
                    <DataTable :value="vehiculoMarcas" paginator :rows="10">
                        <Column
                            field="nombre"
                            header="Nombre"
                            sortable
